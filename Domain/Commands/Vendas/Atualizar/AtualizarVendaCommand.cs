...
{
    public class AtualizarVendaCommand : VendaCommand<AtualizarVendaCommand>
    {
        

        public AtualizarVendaCommand(Guid id, Guid idStatus, Guid idCliente, List<VendaOrdemCommand>? vendaOrdem, bool impressaoEspecial, string? impressaoEspecialTexto, bool? faturaManual, bool? ocultarTotal, bool? comIpi,

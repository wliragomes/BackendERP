...
{
    public class AdicionarPessoaCommand : PessoaCommand<AdicionarPessoaCommand>
    {
        public AdicionarPessoaCommand()
        {

        }

        public AdicionarPessoaCommand(Guid id, bool ativo, bool cliente, bool fornecedor, bool juridica, bool estrangeiro, bool nacional, bool usuario, bool? vendedor, bool motorista, string? cnpjCpf, string? razaoSocial,

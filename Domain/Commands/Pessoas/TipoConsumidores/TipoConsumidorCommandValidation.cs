...
{
    public class TipoConsumidorCommandValidation<T> : AbstractValidator<TipoConsumidorCommand<T>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public TipoConsumidorCommandValidation(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(c => c)
                ...
                .WithState(x => x.Nome)
                .WithMessage(TipoConsumidorConstant.NOME_JA_REGISTRADO)
        ...
        private async Task<bool> NomeExistInDb(string nome, Guid? id) =>
           !await _unitOfWork.TipoConsumidorRepository.ExisteNomeAsync(nome, id);
    }
}
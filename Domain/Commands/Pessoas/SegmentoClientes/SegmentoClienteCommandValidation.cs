...
{
    public class SegmentoClienteCommandValidation<T> : AbstractValidator<SegmentoClienteCommand<T>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public SegmentoClienteCommandValidation(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(c => c)
                ...
                .WithMessage(SegmentoClienteConstant.DESCRICAO_JA_REGISTRADO)
        ...
        private async Task<bool> DescricaoExistInDb(string descricao, Guid? id) =>
           !await _unitOfWork.SegmentoClienteRepository.ExisteDescricaoAsync(descricao, id);
    }
}
...
{
    public class OrigemCommandValidation<T> : AbstractValidator<OrigemCommand<T>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public OrigemCommandValidation(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(c => c)
                ...
                .WithMessage(OrigemConstant.DESCRICAO_JA_REGISTRADO)
        ...
        private async Task<bool> DescricaoExistInDb(string descricao, Guid? id) =>
           !await _unitOfWork.OrigemRepository.ExisteDescricaoAsync(descricao, id);
    }
}

...
{
    public class AtualizarFluxoCaixaCommand : FluxoCaixaCommand<AtualizarFluxoCaixaCommand>
    {
        public AtualizarFluxoCaixaCommand(Guid id, DateTime? caixa, Guid? idOperacao, Guid? idCliente, int? creditoDebito, int? chequeCartao, Guid ? idBanco, Guid ? idCartao,  string? agencia,
        ...
        public AtualizarFluxoCaixaCommand()
        {

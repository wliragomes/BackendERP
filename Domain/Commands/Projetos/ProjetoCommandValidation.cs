...
{
    public class ProjetoCommandValidation<T> : AbstractValidator<ProjetoCommand<T>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public ProjetoCommandValidation(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(c => c)
                ...
                .WithState(x => x.Nome)
                .WithMessage(ProjetoConstant.NOME_JA_REGISTRADO)
        ...
        {
            return !await _unitOfWork.ProjetoRepository.ExisteNomeAsync(nome, id);
        }
    }
}

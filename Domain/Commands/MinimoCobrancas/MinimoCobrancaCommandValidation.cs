...
{
    public class MinimoCobrancaCommandValidation<T> : AbstractValidator<MinimoCobrancaCommand<T>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public MinimoCobrancaCommandValidation(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(c => c.ValorMinimoCobranca)
                .NotNull()
                .WithMessage(ErrorMessages.CANNOT_BE_EMPTY);
            ...
            RuleFor(c => c)
                ...
                .WithMessage(MinimoCobrancaConstant.DESCRICAO_JA_REGISTRADO)
        ...
        {
            return !await _unitOfWork.MinimoCobrancaRepository.ExisteDescricaoAsync(descricao, id);
        }
    }
}

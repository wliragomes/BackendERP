...
{
    public class AcabamentoCommandValidation<T> : AbstractValidator<AcabamentoCommand<T>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public AcabamentoCommandValidation(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(c => c)
                ...
                .WithMessage(AcabamentoConstant.ACABAMENTO_JA_REGISTRADO)
        ...
        {
            return !await _unitOfWork.AcabamentoRepository.ExisteDescricaoAsync(descricao, id);
        }
    }
}

...
{
    public class TipoRodadoCommandValidation<T> : AbstractValidator<TipoRodadoCommand<T>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public TipoRodadoCommandValidation(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(c => c)
                ...
                .WithMessage(TipoRodadoConstant.DESCRICAO_JA_REGISTRADO)
        ...
        {
            return !await _unitOfWork.TipoRodadoRepository.ExisteDescricaoAsync(descricao, id);
        }
    }
}

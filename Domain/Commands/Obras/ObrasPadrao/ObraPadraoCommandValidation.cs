...
{
    public class ObraPadraoCommandValidation<T> : AbstractValidator<ObraPadraoCommand<T>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public ObraPadraoCommandValidation(IUnitOfWork unitOfWork)
        {
        ...
        {
            return !await _unitOfWork.ObraPadraoRepository.ExisteNomeAsync(nome, id);
        }
    }
}

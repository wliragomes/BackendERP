...
{
    public class FaturaTemporariaItemCommand
    {
        ...
        public FaturaTemporariaItemCommand()
        {

        }

        public FaturaTemporariaItemCommand(Guid idFaturaTemporaria, int? sqItem, Guid? idProduto, decimal? qtdProduto, decimal? valorUnitarioProduto, decimal? valorTotalProduto,

...
{
    public class AdicionarProdutoCommand : ProdutoCommand<AdicionarProdutoCommand>
    {
        ...
        public AdicionarProdutoCommand(Guid id, string? CodigoAmigavel, string? nome, Guid idUnidadeMedida, decimal Espessura, decimal PesoBruto, decimal PesoLiquido,

...
{
    public class SubgrupoCommandValidation<T> : AbstractValidator<SubgrupoCommand<T>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public SubgrupoCommandValidation(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(c => c)
                ...
                .WithMessage(SubgrupoConstant.NOME_JA_REGISTRADO)
        ...
        private async Task<bool> NomeExistInDb(string nome, Guid? id) =>
           !await _unitOfWork.SubgrupoRepository.ExisteNomeAsync(nome, id);
    }
}

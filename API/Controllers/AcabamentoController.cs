...
namespace API.Controllers
{
    ...
    [ApiController]
    public class AcabamentoController : PrincipalController
    {
        private readonly IAcabamentoService _acabamentoService;

        public AcabamentoController(IAcabamentoService AcabamentoService)
        {
            _acabamentoService = AcabamentoService;
        }
        ...
        [SwaggerOperation(Summary = "Cria-se um novo Acabamento")]
        [ProducesResponseType(StatusCodes.Status201Created, Type = typeof(Post201OKType<AdicionarAcabamentoCommand>))]
        [ProducesResponseType(StatusCodes.Status206PartialContent, Type = typeof(Post206OKListType<AdicionarAcabamentoCommand>))]
        [ProducesResponseType(StatusCodes.Status207MultiStatus, Type = typeof(Post207OKListType<AdicionarAcabamentoCommand>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(Error400OKType<AdicionarAcabamentoCommand>))]
        ...
        [CustomAuthorize(AcabamentoAccessControl.Create)]
        [HttpPost("criar-acabamento")]
        public async Task<FormularioResponse<AdicionarAcabamentoCommand>> Post([FromBody] AdicionarAcabamentoRequestDto addAcabamentoDto, CancellationToken cancellationToken)
        {
            var responseService = await _acabamentoService.Adicionar(addAcabamentoDto, cancellationToken);
        ...
        /// <response code="409"> Conflict			    - 0000 >> Houve um problema ao realizar esta operação, operação já ocorrida. </response>    
        /// <response code="500"> InternalServerError	- 0000 >> Houve um problema no servidor, retornaremos em breve. Para mais detalhes entre em contato com o suporte. </response>    
        [SwaggerOperation(Summary = "Atualiza o Acabamento")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(Update200OKType<AtualizarAcabamentoCommand>))]
        [ProducesResponseType(StatusCodes.Status206PartialContent, Type = typeof(Post206OKListType<AtualizarAcabamentoCommand>))]
        [ProducesResponseType(StatusCodes.Status207MultiStatus, Type = typeof(Post207OKListType<AtualizarAcabamentoCommand>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(Error400OKType<AtualizarAcabamentoCommand>))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized, Type = typeof(Error401Unauthorized))]
        [ProducesResponseType(StatusCodes.Status402PaymentRequired, Type = typeof(Error402PaymentRequired))]
        [ProducesResponseType(StatusCodes.Status403Forbidden, Type = typeof(Error403Forbidden))]
        [ProducesResponseType(StatusCodes.Status409Conflict, Type = typeof(Error409Conflict))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(Error500))]
        [CustomAuthorize(AcabamentoAccessControl.Update)]
        [HttpPut("atualizar-acabamento")]
        public async Task<FormularioResponse<AtualizarAcabamentoCommand>> Put([FromBody] AtualizarAcabamentoRequestDto updateAcabamentoDto, CancellationToken cancellationToken)
        {
            var responseService = await _acabamentoService.Atualizar(updateAcabamentoDto, cancellationToken);
            return CustomResponse(responseService);
        }
        ...
        /// <response code="409"> Conflict			    - 0000 >> Houve um problema ao realizar esta operação, operação já ocorrida. </response>    
        /// <response code="500"> InternalServerError	- 0000 >> Houve um problema no servidor, retornaremos em breve. Para mais detalhes entre em contato com o suporte. </response>    
        [SwaggerOperation(Summary = "Exclui um ou mais Acabamentos")]
        ...
        [ProducesResponseType(StatusCodes.Status409Conflict, Type = typeof(Error409Conflict))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(Error500))]
        [CustomAuthorize(AcabamentoAccessControl.Delete)]
        [HttpDelete("remove-acabamento")]
        public async Task<List<FormularioResponse<ExcluirAcabamentoCommand>>> Delete([FromBody] ExcluirAcabamentoDto deleteAcabamentoDto, CancellationToken cancellationToken)
        {
            var responseService = await _acabamentoService.Excluir(deleteAcabamentoDto, cancellationToken);
            return CustomResponse(responseService);
        }
        ...
        /// <response code="403"> Forbidden			    - 0000 >> Houve um problema não foi possível realizar esta operação, entre em contato com suporte. </response>
        /// <response code="500"> InternalServerError	- 0000 >> Houve um problema no servidor, retornaremos em breve. Para mais detalhes entre em contato com o suporte. </response>    
        [SwaggerOperation(Summary = "Lista de Acabamentos")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(PaginationResponseType<AcabamentoDto>))]
        [ProducesResponseType(StatusCodes.Status207MultiStatus, Type = typeof(PaginationResponse207Type<AcabamentoDto>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(Error400Get))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized, Type = typeof(Error401Unauthorized))]
        [ProducesResponseType(StatusCodes.Status402PaymentRequired, Type = typeof(Error402PaymentRequired))]
        [ProducesResponseType(StatusCodes.Status403Forbidden, Type = typeof(Error403Forbidden))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(Error500))]
        [CustomAuthorize(AcabamentoAccessControl.Read)]
        [HttpGet("retornar-acabamento")]
        public async Task<ActionResult> GetFilter([FromQuery] PaginacaoRequest paginationRequest)
        {
            var responseService = await _acabamentoService.RetornarPaginacao(paginationRequest);
        ...
        /// <response code="403"> Forbidden			    - 0000 >> Houve um problema não foi possível realizar esta operação, entre em contato com suporte. </response>
        /// <response code="500"> InternalServerError	- 0000 >> Houve um problema no servidor, retornaremos em breve. Para mais detalhes entre em contato com o suporte. </response>    
        [SwaggerOperation(Summary = "Retornar Acabamento por Id")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(NewResponseType<AcabamentoDto>))]
        [ProducesResponseType(StatusCodes.Status207MultiStatus, Type = typeof(NewResponse207Type<AcabamentoDto>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(Error400Get))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized, Type = typeof(Error401Unauthorized))]
        [ProducesResponseType(StatusCodes.Status402PaymentRequired, Type = typeof(Error402PaymentRequired))]
        [ProducesResponseType(StatusCodes.Status403Forbidden, Type = typeof(Error403Forbidden))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(Error500))]
        [CustomAuthorize(AcabamentoAccessControl.Read)]
        [HttpGet("get-acabamento-by-id")]
        public async Task<ActionResult> GetById(Guid id)
        {
            var responseService = await _acabamentoService.RetornarPorId(id);
            return CustomResponse(responseService);
        }
    }
}

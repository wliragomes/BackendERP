...
namespace API.Controllers
{
    ...
    [ApiController]
    public class FaturaTemporariaController : PrincipalController
    {
        private readonly IFaturaTemporariaService _faturaTemporariaService;

        public FaturaTemporariaController(IFaturaTemporariaService FaturaTemporariaService)
        {
            _faturaTemporariaService = FaturaTemporariaService;
        }
        ...
        [SwaggerOperation(Summary = "Cria-se uma nova Fatura Temporaria")]
        [ProducesResponseType(StatusCodes.Status201Created, Type = typeof(Post201OKType<AdicionarFaturaTemporariaCommand>))]
        [ProducesResponseType(StatusCodes.Status206PartialContent, Type = typeof(Post206OKListType<AdicionarFaturaTemporariaCommand>))]
        [ProducesResponseType(StatusCodes.Status207MultiStatus, Type = typeof(Post207OKListType<AdicionarFaturaTemporariaCommand>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(Error400OKType<AdicionarFaturaTemporariaCommand>))]
        ...
        [CustomAuthorize(FaturaTemporariaAccessControl.Create)]
        [HttpPost]
        public async Task<FormularioResponse<AdicionarFaturaTemporariaCommand>> Post([FromBody] AdicionarFaturaTemporariaRequestDto addFaturaTemporariaDto, CancellationToken cancellationToken)
        {
            var responseService = await _faturaTemporariaService.Adicionar(addFaturaTemporariaDto, cancellationToken);
        ...
        /// <response code="409"> Conflict			    - 0000 >> Houve um problema ao realizar esta operação, operação já ocorrida. </response>    
        /// <response code="500"> InternalServerError	- 0000 >> Houve um problema no servidor, retornaremos em breve. Para mais detalhes entre em contato com o suporte. </response>    
        [SwaggerOperation(Summary = "Exclui um ou mais Faturas Temporarias")]
        ...
        [ProducesResponseType(StatusCodes.Status409Conflict, Type = typeof(Error409Conflict))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(Error500))]
        [CustomAuthorize(FaturaTemporariaAccessControl.Delete)]
        [HttpDelete]
        public async Task<List<FormularioResponse<ExcluirFaturaTemporariaCommand>>> Delete([FromBody] ExcluirFaturaTemporariaDto deleteFaturaTemporariaDto, CancellationToken cancellationToken)
        {
            var responseService = await _faturaTemporariaService.Excluir(deleteFaturaTemporariaDto, cancellationToken);
            return CustomResponse(responseService);
        }
        ...
        /// <response code="403"> Forbidden			    - 0000 >> Houve um problema não foi possível realizar esta operação, entre em contato com suporte. </response>
        /// <response code="500"> InternalServerError	- 0000 >> Houve um problema no servidor, retornaremos em breve. Para mais detalhes entre em contato com o suporte. </response>    
        [SwaggerOperation(Summary = "Retornar Fatura Temporaria por Id")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(NewResponseType<FaturaTemporariaByCodeDto>))]
        [ProducesResponseType(StatusCodes.Status207MultiStatus, Type = typeof(NewResponse207Type<FaturaTemporariaByCodeDto>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(Error400Get))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized, Type = typeof(Error401Unauthorized))]
        [ProducesResponseType(StatusCodes.Status402PaymentRequired, Type = typeof(Error402PaymentRequired))]
        [ProducesResponseType(StatusCodes.Status403Forbidden, Type = typeof(Error403Forbidden))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(Error500))]
        [CustomAuthorize(FaturaTemporariaAccessControl.Read)]
        [HttpGet("get-fatura-temporaria-by-id")]
        public async Task<ActionResult> GetById(Guid id)
        {
            var responseService = await _faturaTemporariaService.RetornarPorId(id);
            return CustomResponse(responseService);
        }
    }
}